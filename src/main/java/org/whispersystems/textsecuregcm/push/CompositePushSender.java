...
public class CompositePushSender implements Managed, PushSender {

  private final Logger logger = LoggerFactory.getLogger(CompositePushSender.class);
  ...
  public CompositePushSender(ApnFallbackManager apnFallbackManager,
                    ...
                    WebsocketSender websocketSender, int queueSize)
  {
    ...
    SharedMetricRegistries.getOrCreate(Constants.METRICS_NAME)
                          .register(name(CompositePushSender.class, "send_queue_depth"),
